...
export default function FindRoute({ children }: { children: ReactNode }) {
  ...
  const findRoute = async () => {
    ...
    const allowBypass = location.pathname.includes('create') || location.pathname.includes('landing') || location.pathname.includes('test') || location.pathname.includes('deposit') || location.pathname.includes('details') || location.pathname.includes('dashboard') || location.pathname.includes('create') || location.pathname.includes('withdraw') || location.pathname.includes('intro') || location.pathname.includes('verifyEmail');
