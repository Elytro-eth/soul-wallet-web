...
export default function RecoverProgress({ onNext }: any) {
  ...
  return (
    <Box width="100%" height="100%" padding="30px" paddingTop="40px">
      ...
      <Button onClick={onNext} size="xl" type="blue" width="100%" marginTop="30px" marginBottom="60px">Share</Button>
      <Box
        fontWeight="700"
        fontSize="18px"
        width="100%"
      ...
      >
        ...
        <Box marginLeft="auto">
          <Box color="#848488" background="#F3F3F3" padding="2px 8px" borderRadius="24px" display="flex" alignItems="center">
            <Box marginRight="4px"><WaitingIcon /></Box>
            <Box>Waiting</Box>
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        <Box marginLeft="auto">
          <Box marginLeft="auto">
            <Box color="#0CB700" background="#F5FFF4" padding="2px 8px" borderRadius="24px" fontWeight="600" display="flex" alignItems="center">
              <Box marginRight="4px"><ApprovedIcon /></Box>
              <Box>Approved</Box>
            </Box>
          </Box>
        </Box>
