...
export default function GuardianForm({
  ...
  const defaultGuardianIds = getDefaultGuardianIds((guardiansInfo && guardianDetails.guardians && guardianDetails.guardians.length > 1 && guardianDetails.guardians.length) || 1)
