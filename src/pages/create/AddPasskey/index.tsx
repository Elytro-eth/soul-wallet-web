...
export default function AddPasskey({ onNext, onSkip }: any) {
  return (
    <Box width="100%" height="100%" padding="30px" paddingTop="138px" display="flex" alignItems="center" justifyContent="center" flexDirection="column">
      ...
      <Box width="100%" marginBottom="50px" marginTop="24px">
      ...
      <Button disabled={false} size="xl" type="black" onClick={onNext} minWidth="195px">Add</Button>
    </Box>
  );
}
